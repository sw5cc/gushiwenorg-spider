...
from gushiwen_master.user_agent import USER_AGENTS
from gushiwen_master.utils.proxy_helper import get_http_proxies
...
class GushiwenMasterSpiderMiddleware(object):
...
class GushiwenMasterDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
